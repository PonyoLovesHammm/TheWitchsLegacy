...
public class TreeFeatures {
    ...
    private static FallenTreeConfiguration.FallenTreeConfigurationBuilder createFallenBirch(int p_409905_) {
        return createFallenTrees(Blocks.BIRCH_LOG, 5, p_409905_);
    }
    ...
    private static FallenTreeConfiguration.FallenTreeConfigurationBuilder createFallenTrees(Block p_410650_, int p_409717_, int p_410251_) {
        return new FallenTreeConfiguration.FallenTreeConfigurationBuilder(BlockStateProvider.simple(p_410650_), UniformInt.of(p_409717_, p_410251_))
            .logDecorators(
                ImmutableList.of(
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> p_321605_) {
        ...
        FeatureUtils.register(p_321605_, DARK_OAK, Feature.TREE, createDarkOak().ignoreVines().build());
        FeatureUtils.register(
            p_321605_,
            PALE_OAK,
            Feature.TREE,
        ...
        FeatureUtils.register(
            p_321605_, OAK_LEAF_LITTER, Feature.TREE, createOak().decorators(ImmutableList.of(placeongrounddecorator, placeongrounddecorator1)).build()
        );
        FeatureUtils.register(
            p_321605_,
        ...
        FeatureUtils.register(
            p_321605_, BIRCH_LEAF_LITTER, Feature.TREE, createBirch().decorators(ImmutableList.of(placeongrounddecorator, placeongrounddecorator1)).build()
        );
        FeatureUtils.register(
            p_321605_, FANCY_OAK_LEAF_LITTER, Feature.TREE, createFancyOak().decorators(List.of(placeongrounddecorator, placeongrounddecorator1)).build()
        );
        FeatureUtils.register(p_321605_, FALLEN_OAK_TREE, Feature.FALLEN_TREE, createFallenOak().build());
        FeatureUtils.register(p_321605_, FALLEN_BIRCH_TREE, Feature.FALLEN_TREE, createFallenBirch(8).build());
        FeatureUtils.register(p_321605_, FALLEN_SUPER_BIRCH_TREE, Feature.FALLEN_TREE, createFallenBirch(15).build());
        FeatureUtils.register(p_321605_, FALLEN_JUNGLE_TREE, Feature.FALLEN_TREE, createFallenJungle().build());
        FeatureUtils.register(p_321605_, FALLEN_SPRUCE_TREE, Feature.FALLEN_TREE, createFallenSpruce().build());
    }
}
