...
public final class TreeGrower {
    ...
    private @Nullable ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(RandomSource p_304525_, boolean p_304410_) {
    ...
    private @Nullable ResourceKey<ConfiguredFeature<?, ?>> getConfiguredMegaFeature(RandomSource p_304575_) {
    ...
    public boolean growTree(ServerLevel p_304396_, ChunkGenerator p_304672_, BlockPos p_304643_, BlockState p_304439_, RandomSource p_304893_) {
                ...
                for (int i = 0; i >= -1; i--) {
                    for (int j = 0; j >= -1; j--) {
                        if (isTwoByTwoSapling(p_304439_, p_304396_, p_304643_, i, j)) {
                            ...
                            p_304396_.setBlock(p_304643_.offset(i, 0, j), blockstate, 260);
                            p_304396_.setBlock(p_304643_.offset(i + 1, 0, j), blockstate, 260);
                            p_304396_.setBlock(p_304643_.offset(i, 0, j + 1), blockstate, 260);
                            p_304396_.setBlock(p_304643_.offset(i + 1, 0, j + 1), blockstate, 260);
                            if (configuredfeature.place(p_304396_, p_304672_, p_304893_, p_304643_.offset(i, 0, j))) {
                                return true;
                            }

                            p_304396_.setBlock(p_304643_.offset(i, 0, j), p_304439_, 260);
                            p_304396_.setBlock(p_304643_.offset(i + 1, 0, j), p_304439_, 260);
                            p_304396_.setBlock(p_304643_.offset(i, 0, j + 1), p_304439_, 260);
                            p_304396_.setBlock(p_304643_.offset(i + 1, 0, j + 1), p_304439_, 260);
                            return false;
                        }
                    }
                }
        ...
        if (resourcekey1 == null) {
            ...
            if (holder1 == null) {
                ...
                p_304396_.setBlock(p_304643_, blockstate1, 260);
                if (configuredfeature1.place(p_304396_, p_304672_, p_304893_, p_304643_)) {
                    ...
                    p_304396_.setBlock(p_304643_, p_304439_, 260);
                    return false;
                }
            }
        }
