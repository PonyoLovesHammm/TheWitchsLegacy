...
public class TheWitchsLegacy {
    ...
    public TheWitchsLegacy(IEventBus modEventBus, ModContainer modContainer) {
        ...
        NeoForge.EVENT_BUS.addListener(WaitingRitualManager::onServerTick);
        NeoForge.EVENT_BUS.addListener(CreatureTeleportation::onServerTick);
        NeoForge.EVENT_BUS.addListener(DemonSummon::onLivingDeath);
        NeoForge.EVENT_BUS.addListener(WitherSummon::onLivingDeath);
