...
public final class AltarPowerSources {
    ...
    private static final List<SourceCategory> CATEGORIES = List.of(
            ...
            category("water", 1, 50, state -> state.getFluidState().getType() == Fluids.WATER && state.getFluidState().isSource()),
            ...
            category("pumpkin_stem", 2, 10, blocks(Blocks.PUMPKIN_STEM, Blocks.ATTACHED_PUMPKIN_STEM)),
            category("melon_stem", 2, 10, blocks(Blocks.MELON_STEM, Blocks.ATTACHED_MELON_STEM)),
            ...
            category("vanilla_leaves", 3, 200, blocks(
            ...
            category("sugar_cane_bamboo", 3, 50, blocks(Blocks.SUGAR_CANE, Blocks.BAMBOO)),
            category("coral", 3, 10, blocks(
                    Blocks.TUBE_CORAL, Blocks.BRAIN_CORAL, Blocks.BUBBLE_CORAL, Blocks.FIRE_CORAL, Blocks.HORN_CORAL
            )),
            category("coral_fan", 3, 10, blocks(
            ...
            category("torchflower", 5, 5, blocks(Blocks.TORCHFLOWER)),
            category("pitcher_plant", 5, 5, blocks(Blocks.PITCHER_CROP)),
            category("spore_blossom", 5, 2, blocks(Blocks.SPORE_BLOSSOM)),
            category("amethyst_cluster", 5, 5, blocks(Blocks.AMETHYST_CLUSTER)),
            category("froglight", 5, 1, blocks(Blocks.OCHRE_FROGLIGHT, Blocks.VERDANT_FROGLIGHT, Blocks.PEARLESCENT_FROGLIGHT)),
